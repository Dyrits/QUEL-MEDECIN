...
public class TestPersonnes {
	private static Adresse sh = new Adresse(
			"ZAC du Moulin Neuf",
			2,
			"B",
	...
	private static MedecinGeneraliste melanie = new MedecinGeneraliste(
			"Malalaniche",
			"Mélanie",
			"02.28.03.17.28",
			sh
	);
	private static Adresse nio = new Adresse(
			19,
			"avenue Léo Lagrange",
			79000,
			"Niort"
	);
	private static Patient adhemar;
	static {
		try {
			adhemar = new Patient(
					"Pamamobe",
